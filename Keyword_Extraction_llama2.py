...
model_id = "meta-llama/Llama-2-7b-chat-hf"
tokenizer_llama2 = AutoTokenizer.from_pretrained(model_id)
...
generator_llama2 = pipeline(
    "text-generation",
    model=model_llama2, tokenizer=tokenizer_llama2, max_new_tokens=100, temperature=0.1,
...
def extract_keywords_from_abstract(abstract):
    ...
    # llama2_zero_shot
    llm_llama2 = TextGeneration(generator_llama2, prompt=prompt_zero_shot)
    ...
    # llama2_one_shot
    llm_llama2 = TextGeneration(generator_llama2, prompt=prompt_one_shot)
    kw_model_llama2 = KeyBERT(llm=llm_llama2, model='BAAI/bge-small-en-v1.5')
    raw_keywords = kw_model_llama2.extract_keywords([abstract], threshold=0.5)[0]
...
extraction_functions = {
    "llama2_KeyBERT_zero_shot": lambda abstract: extract_keywords_from_abstract(abstract)["llama2_KeyBERT_zero_shot"],
    "llama2_KeyBERT_one_shot": lambda abstract: extract_keywords_from_abstract(abstract)["llama2_KeyBERT_one_shot"],
}
