...
def evaluate_keywords_from_data(base_path, datasets, extraction_functions, output_folder):
    ...
    with open(os.path.join(output_folder, 'evaluation_results_mistral.csv'), 'w', newline='', encoding='utf-8') as csvfile:
    ...
    with open(os.path.join(output_folder, 'evaluation_results_avg_mistral.csv'), 'w', newline='', encoding='utf-8') as csvfile:
        writer = csv.writer(csvfile)
