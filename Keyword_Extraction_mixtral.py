...
def extract_keywords_from_abstract(abstract):
    ...
    return {
        "Mixtral7B_KeyBERT_zero_shot": cleaned_keywords_zero_shot,
        "Mixtral7B_KeyBERT_one_shot": cleaned_keywords_one_shot,
    }
...
extraction_functions = {
    "Mixtral7B_KeyBERT_zero_shot": lambda abstract: extract_keywords_from_abstract(abstract)["Mixtral7B_KeyBERT_zero_shot"],
    "Mixtral7B_KeyBERT_one_shot": lambda abstract: extract_keywords_from_abstract(abstract)["Mixtral7B_KeyBERT_one_shot"],
}
